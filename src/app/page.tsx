      ...
      <main role="main">
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <h2 id="expertise-heading" className="text-4xl md:text-6xl font-bold text-white text-center mb-12 uppercase tracking-wide">
              // My Expertise
            </h2>
            ...
            <div className="border-4 border-white bg-[#242428] overflow-hidden mx-4 md:mx-8 lg:mx-16">
              <div className="grid grid-cols-1 md:grid-cols-3 divide-y-4 md:divide-y-0 md:divide-x-4 divide-white">
                ...
                <article className="p-10 hover:bg-[#2a2a2e] transition-colors">
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="flex justify-start mb-16">
              <h2 id="work-heading" className="text-7xl md:text-8xl lg:text-9xl font-black text-white opacity-90 leading-none tracking-tight">
                MY<br />WORK
              </h2>
            </div>
