...
>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    {/* FONT UPDATE: Use Poppins for the main heading */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 divide-y-4 md:divide-y-0 md:divide-x-4 divide-white">
        ...
        <article className="p-10 hover:bg-[#252529] transition-colors">
          <div className="flex items-start mb-4">
            ...
            {/* FONT UPDATE: Use Poppins for the card title */}
            <h3 className="font-poppins text-3xl font-bold text-white"># Software Development</h3>
          </div>
         
          {/* FONT UPDATE: Use Roboto Mono for code-like text (this is the code-editor-style) */}
          ...
          <div className="border-l-4 border-red-500 pl-4 ml-2">
            {/* FONT UPDATE: Use Roboto Mono for the technical description (like Tamal's "code-editor-style") */}
          ...
          {/* FONT UPDATE: Use Roboto Mono for code-like text */}
        ...
        <article className="p-10 hover:bg-[#252529] transition-colors">
          ...
          <div className="border-l-4 border-red-500 pl-4 ml-2">
            {/* FONT UPDATE: Use Roboto Mono for the technical description */}
            <p className="font-roboto-mono text-gray-300 text-lg leading-relaxed">
    ...
    {/* Additional IDE Code Pattern - Keep as Roboto Mono */}
    <div className="mt-12 mx-4 md:mx-8 lg:mx-16 opacity-40">
      <div className="font-roboto-mono text-sm text-gray-400 border-l-4 border-gray-600 pl-4 py-2">
        ...
        <section 
          id="work" 
          className="py-20 bg-[#1A191D] font-sans relative overflow-hidden"
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="flex justify-start mb-16">
              <h2 id="work-heading" className="elementor-heading-title code-editor-style text-7xl md:text-8xl lg:text-9xl font-black text-white opacity-90 leading-none tracking-tight">
                MY<br />WORK
              </h2>
            </div>
            ...
            <div className="relative mt-8 flex justify-end">
              <div className="code-editor-style text-lg md:text-xl font-bold text-white opacity-100 space-y-2 max-w-4xl mr-auto">
                ...
                <article className="group cursor-pointer">
                  <Link href="/projects/trend-following-strategy" aria-label="View Trend Following Strategy project">
                    <div className="relative overflow-hidden bg-transparent transition-all duration-500">
                      ...
                      <div className="bg-[#1A191D] p-6 rounded-b-[5px] min-h-[120px] flex flex-col justify-center">
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 id="experience-heading" className="text-4xl md:text-6xl font-bold text-white mb-12 uppercase tracking-wide">
              // Experience
            </h2>
        ...
        <section 
          id="contact" 
          className="py-20 bg-[#1A191D]"
          aria-labelledby="contact-heading"
          role="region"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 id="contact-heading" className="text-4xl md:text-6xl font-bold text-white text-center mb-12 uppercase">// Contact</h2>
