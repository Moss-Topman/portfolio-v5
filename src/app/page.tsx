...
export default function Home() {
  return (
    <>
      <Hero />
      <section id="expertise" className="py-20 bg-gradient-to-b from-[#001022] to-[#0a0a0f]">
      ...
      <section id="work" className="py-20 bg-[#0a0a0f]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section id="experience" className="py-20 bg-gradient-to-b from-[#0a0a0f] to-[#001022]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <div className="mb-8 flex justify-between items-center">
              ...
              <div className="w-2/12 text-center z-10">
                <div className="bg-purple-500 rounded-full h-4 w-4 mx-auto"></div>
              </div>
      ...
      <section id="contact" className="py-20 bg-[#001022]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
